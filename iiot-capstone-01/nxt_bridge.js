...
const NXT_DEVICES = [
    { name: 'NXT-1', comPort: 'COM13' }, // DO, RE, MI
    { name: 'NXT-2', comPort: 'COM17' }, // FA, SOL, LA
    { name: 'NXT-3', comPort: 'COM12' }, // SI, DO_TINGGI
];
...
const client = mqtt.connect('mqtt://10.6.100.80:1883');
client.on('connect', () => {
